...
import App from './TutorRegistration';
...
class TutorRegistrationContainer extends Component<Props> {
...
export default connect(mapStateToProps, mapDispatchToProps)(TutorRegistrationContainer)
